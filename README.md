# cypress-split-example ![cypress version](https://img.shields.io/badge/cypress-12.3.0-brightgreen) ![cypress-split version](https://img.shields.io/badge/cypress--split-1.0.0-brightgreen)
...
Reusable GHA | [reusable.yml](./.github/workflows/reusable.yml) |
